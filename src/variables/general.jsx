...
const dataTable = {
  headerRow: ["Name", "Process", "Office", "Remaining Transactions", "Total Transactions"],
  footerRow: ["Name", "Process", "Office", "Remaining Transactions", "Total Transactions"],
  dataRows: [
    ["Process", "Invoice Control", "0", "152"],
    ["CreateQueue", "Invoice Control", "14", "63"],
    ["Process", "Certificate Of Analysis", "0", "98"],
    ["Scheduler", "Push Pull Deliveries", "78", "164"]
  ]
};
